...
## REAL_COVER — 200 countries (Wikimedia Commons photo)
...
| MG | Madagascar | en.wikipedia.org/wiki/Malagasy_passport |
...
| ST | Sao Tome and Principe | en.wikipedia.org/wiki/Santomean_passport |
| SA | Saudi Arabia | en.wikipedia.org/wiki/Saudi_passport |
| SN | Senegal | commons.wikimedia.org/wiki/Category:Pass |
| RS | Serbia | en.wikipedia.org/wiki/Serbian_passport |
...
| SI | Slovenia | en.wikipedia.org/wiki/Slovenian_passport |
