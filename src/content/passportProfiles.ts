...
export const PASSPORT_PROFILES: Record<string, PassportProfile> = {
  ...
  HK: {
    ...
    backgroundCheck: {
      ...
      issuer: "Hong Kong Police Force — Identification Bureau",
      url: "https://www.police.gov.hk/ppp_en/11_useful_info/cert_no_crime.html",
      fee: "HK$250 (~USD 32)",
      processingTime: "8-10 working days",
      notes: "Required for many overseas long-stay applications. Direct submission to overseas embassy on applicant's request; HK Police won't release directly to the individual.",
    },
    apostille: {
      issuer: "High Court of the HKSAR — Apostille Service",
      url: "https://www.judiciary.hk/en/court_services_facilities/apostille.html",
      fee: "HK$165 per document (~USD 21)",
      processingTime: "5 working days standard",
      hagueSignatory: true,
      notes: "HKSAR is a separate Hague signatory from China; HK-issued documents go through HKSAR's High Court, NOT the Chinese MFA. Documents must be notarised by a HK solicitor / Notary Public first.",
    },
    taxRecords: {
      name: "BIR60 + Tax Return + Notice of Assessment",
      issuer: "Inland Revenue Department (IRD)",
      url: "https://www.ird.gov.hk/eng/tax/ind.htm",
      notes: "Salaried HK residents file BIR60 annually. IRD Notice of Assessment is the proof of taxable income. Print from MyTax portal at any time.",
    },
    translation: {
      accreditation: "Sworn translator listed by HK Court Interpreters Office",
      notes: "For Chinese-into-English documents (rare for HK residents), HK Court has an official list. For other languages, target country's consulate-approved list applies.",
    },
    consulateGeography: "Most major embassies in Central, Admiralty, Wan Chai. Schengen consulates concentrated in Central. Australian + Canadian Consulates also in Central tower complexes.",
    standardCivilDocuments: [
      "Hong Kong SAR passport (10-year validity)",
      "Hong Kong Permanent Identity Card (HKID)",
      "Address proof (utility bill / bank statement, within 3 months — government services use the AddressVerification System)",
      "HSBC / Hang Seng / Bank of China (HK) statements (last 6 months)",
      "Marriage Certificate (Aiguo's Office) for spouses",
      "Birth Certificate (Immigration Department, K notarised + apostille)",
    ],
    generalNotes: "HKSAR passport opens ~170 visa-free destinations — among the strongest Asian passports. Post-2020 emigration surge to UK (BN(O)), Canada (Stream B), Australia (Hong Kong streams), Taiwan made dual-passport documentation a frequent need.",
  },
  ...
  TW: {
    ...
    backgroundCheck: {
      name: "Police Criminal Record Certificate",
      issuer: "National Police Agency, Ministry of the Interior",
      url: "https://www.npa.gov.tw/",
      fee: "NT$100 per copy",
      processingTime: "5 working days",
      notes: "Apply at local Police Bureau Foreign Affairs Division or via online portal. Apostille separately at MOFA.",
    },
    apostille: {
      issuer: "Bureau of Consular Affairs (BOCA), Ministry of Foreign Affairs",
      url: "https://www.boca.gov.tw/sp-faqe-1-1.html",
      fee: "NT$400 per document",
      processingTime: "3 working days at Taipei BOCA; 5 days regional offices",
      hagueSignatory: false,
      notes: "Taiwan is NOT a Hague signatory — uses double-legalisation: BOCA authentication, THEN target country's embassy/representative office in Taipei. Adds 7-14 days typical.",
    },
    taxRecords: {
      name: "Income Tax Withholding Statement + Tax Return",
      issuer: "Ministry of Finance — Taxation Administration",
      url: "https://www.mof.gov.tw/Eng/",
      notes: "Annual personal income tax return + employer withholding statements. eTax filing portal generates printable proof.",
    },
    translation: {
      accreditation: "Sworn translator from Taipei District Court list",
      notes: "Civil documents in traditional Chinese need translation into target language. Most consulates require Court-listed translator OR target-country sworn translator.",
    },
    consulateGeography: "Most countries don't have formal embassies (one-China policy). De-facto missions: American Institute in Taiwan (AIT), British Office Taipei, Australian Office Taipei, Canadian Trade Office. Cluster in Xinyi / Da'an districts.",
    standardCivilDocuments: [
      "Taiwan passport (10-year validity)",
      "National ID card",
      "Household Registration (Hukou) — extracts available at Household Registration Office",
      "Bank statements (CTBC / Mega / First Bank / Taipei Fubon common)",
      "Marriage Certificate (Household Registration Office)",
      "Birth Certificate (Household Registration Office)",
    ],
    generalNotes: "Taiwan passport opens ~145 visa-free destinations. Non-Hague legalisation adds 1-2 weeks to most outbound long-stay applications — start documentation 4-6 weeks earlier than other Asian applicants. Taiwan Employment Gold Card holders streamline some intake processes back at home.",
  },
  ...
  CH: {
    ...
    backgroundCheck: {
      name: "Strafregisterauszug / Extrait du casier judiciaire",
      issuer: "Federal Office of Justice (FOJ) — Bundesamt für Justiz",
      url: "https://www.e-service.admin.ch/crex/cms/content/strafregister/main_szr_en",
      fee: "CHF 20 standard / CHF 17 online",
      processingTime: "Online: same-day digital; Postal: 5-10 days",
      notes: "Available in DE/FR/IT/EN. Apostille separately at Federal Chancellery.",
    },
    apostille: {
      issuer: "Cantonal apostille office (varies by document-origin canton) OR Federal Chancellery for federal documents",
      url: "https://www.bk.admin.ch/bk/en/home/regierungsunterstuetzung/internationale-staatsvertraege/apostille.html",
      fee: "CHF 20-30 per document (varies by canton)",
      processingTime: "Same-day to 3 days",
      hagueSignatory: true,
      notes: "Each canton has its own apostille office. Federal documents (FOJ police certificate, federal tax records) go to the Federal Chancellery in Bern. Cantonal documents (cantonal court, civil registry) go to the originating canton.",
    },
    taxRecords: {
      name: "Steuerbescheid / Décision de taxation (annual tax assessment)",
      issuer: "Cantonal tax authority (varies by canton of residence)",
      url: "https://www.estv.admin.ch/",
      notes: "Switzerland levies tax at federal + cantonal + municipal level. Annual tax assessment combines all three; cantonal tax office issues the consolidated proof.",
    },
    translation: {
      accreditation: "Sworn translator registered with the destination's consulate in Bern / Geneva / Zurich",
      notes: "Multi-lingual country — many documents already exist in DE/FR/IT/EN/RM official versions. For unusual target languages, sworn translation from a canton-recognised translator.",
    },
    consulateGeography: "Most embassies in Bern. Major consulates in Geneva (UN-related, French-speaking) + Zurich (US, Asian, business). Italian + German consulates also in Basel + Lugano.",
    standardCivilDocuments: [
      "Swiss passport (10-year validity)",
      "Carte d'identité / Identitätskarte",
      "Wohnsitzbescheinigung / Attestation de domicile (residence certificate from commune)",
      "Bank statements (UBS / Credit Suisse-now-UBS / Raiffeisen / PostFinance)",
      "Marriage Certificate (Zivilstandsamt / Office d'état civil)",
      "Birth Certificate (Zivilstandsamt — long-form, multilingual)",
    ],
    generalNotes: "Swiss passport opens ~190 visa-free destinations — globally top-tier. Bilateral agreements with EU provide effective free movement + most visa benefits. Multilingual documents reduce translation costs vs other applicants.",
  },
  ...
  BE: {
    ...
    preferredCurrency: "EUR",
    backgroundCheck: {
      name: "Extrait du casier judiciaire (Article 595/596)",
      issuer: "Commune of residence — Service de l'État civil",
      url: "https://justice.belgium.be/fr/themes_et_dossiers/personnes_et_familles/casier_judiciaire",
      fee: "Free to €15 (varies by commune)",
      processingTime: "Same-day to 7 days",
      notes: "Issued by the commune where you reside. Models 1, 2, 3, 595, 596 — most visa applications need Model 596 (full criminal record).",
    },
    apostille: {
      issuer: "FPS Foreign Affairs — Legalisation Office",
      url: "https://diplomatie.belgium.be/fr/services/legalisation_de_documents",
      fee: "€20 per document (€10 if same-day digital)",
      processingTime: "Same-day for digital eLegalisation; 5-7 days physical",
      hagueSignatory: true,
      notes: "Belgium pioneered eLegalisation — many documents apostilled fully digitally with QR-code verification. Physical apostille still available for documents that don't have digital originals.",
    },
    taxRecords: {
      name: "Avertissement-extrait de rôle / Aanslagbiljet",
      issuer: "SPF Finances / FOD Financiën",
      url: "https://finances.belgium.be/",
      notes: "Annual tax assessment. Available via MyMinfin online portal for the last 5 tax years.",
    },
    translation: {
      accreditation: "Sworn translator registered with the Belgian Federal Public Service Justice",
      notes: "Belgium has a registered-translator system — all sworn translators are listed in the federal register. Use only registered translators for legalised documents.",
    },
    consulateGeography: "Almost every country has an embassy in Brussels (EU + NATO HQ). Consular districts often cover Belgium + Luxembourg + Netherlands together.",
    standardCivilDocuments: [
      "Belgian passport (7-year validity)",
      "Carte d'identité électronique (eID)",
      "Composition de ménage (household composition certificate from commune)",
      "Bank statements (BNP Paribas Fortis / ING / KBC / Belfius)",
      "Acte de mariage / Huwelijksakte",
      "Acte de naissance / Geboorteakte (long-form, multilingual)",
    ],
    generalNotes: "Belgian passport opens ~189 visa-free destinations. Multilingual country — most civil documents available in FR/NL/DE. Brussels' international concentration means many embassies handle Belgium-specific procedures locally.",
  },
  ...
  AT: {
    ...
    preferredCurrency: "EUR",
    backgroundCheck: {
      name: "Strafregisterbescheinigung",
      issuer: "Federal Police Headquarters (Bundeskriminalamt)",
      url: "https://www.help.gv.at/Portal.Node/hlpd/public/content/172/Seite.1720700.html",
      fee: "€21",
      processingTime: "Same-day at local district commission; 7 days postal",
      notes: "Apply at any Bezirksverwaltungsbehörde (district administrative authority). Apostille separately at the Austrian Federal Ministry for European and International Affairs (BMEIA).",
    },
    apostille: {
      issuer: "BMEIA — Federal Ministry for European and International Affairs",
      url: "https://www.bmeia.gv.at/en/travel-stay/legalisation-of-documents/apostille/",
      fee: "€53 per document",
      processingTime: "1-3 working days at BMEIA Vienna",
      hagueSignatory: true,
      notes: "Austria's apostille is restricted to documents from specific Austrian authorities — court documents, criminal-record certificates, civil-registry documents. Notary documents get apostille from the regional court.",
    },
    taxRecords: {
      name: "Einkommensteuerbescheid / Lohnzettel (L16)",
      issuer: "Finanzamt Österreich",
      url: "https://www.bmf.gv.at/services/finanzonline.html",
      notes: "Annual tax assessment + monthly Lohnzettel for salaried employees. FinanzOnline portal provides digital download for the last 5 years.",
    },
    translation: {
      accreditation: "Gerichtlich beeideter Übersetzer (court-sworn translator)",
      notes: "Austria has a unified federal register of sworn translators. Use only court-sworn translators for legalised documents — accepted at all Austrian + most foreign consulates.",
    },
    consulateGeography: "Embassies clustered in Vienna's 1st + 3rd districts (Innere Stadt + Landstraße). Salzburg has additional honorary consulates for tourism-heavy nationalities.",
    standardCivilDocuments: [
      "Austrian passport (10-year validity)",
      "Personalausweis (national ID card)",
      "Meldezettel (registration certificate from local Magistrat)",
      "Bank statements (Erste Bank / Bank Austria / Raiffeisen / BAWAG)",
      "Heiratsurkunde (marriage certificate, multilingual on request)",
      "Geburtsurkunde (birth certificate, multilingual on request)",
    ],
    generalNotes: "Austrian passport opens ~190 visa-free destinations. EU + Schengen + EEA member. Vienna's UN diplomatic concentration means many consulates handle visa requests locally.",
  },
  ...
  DK: {
    ...
    backgroundCheck: {
      name: "Straffeattest (Police Certificate)",
      issuer: "Rigspolitiet (Danish National Police)",
      url: "https://politi.dk/straffeattest",
      fee: "DKK 175 (~USD 25)",
      processingTime: "Same-day at local police district; up to 10 days postal",
      notes: "Two types: Private Straffeattest (your own use) and Offentlig Straffeattest (employer/visa use). The Offentlig version is required for most visa applications.",
    },
    apostille: {
      issuer: "Danish Ministry of Foreign Affairs — Department of Consular Services",
      url: "https://um.dk/en/about-us/contact-us/legalisation",
      fee: "DKK 270 per document (~USD 39)",
      processingTime: "5 working days standard; same-day premium",
      hagueSignatory: true,
      notes: "Apply online via online.um.dk. Documents must be notarised first OR be original issuances from Danish authorities (the MFA accepts originals from CPR registry, Justice Ministry, courts).",
    },
    taxRecords: {
      name: "Årsopgørelse (Annual Tax Statement) + Forskudsopgørelse",
      issuer: "SKAT (Danish Tax Authority)",
      url: "https://skat.dk/",
      notes: "Annual tax assessment available via TastSelv online portal. Most consulates accept the Årsopgørelse + Forskudsopgørelse for the last 3 years as income proof.",
    },
    translation: {
      accreditation: "Sworn translator (statsautoriseret translator) registered with Danish authorities",
      notes: "Use a statsautoriseret oversætter for legalised documents. Many Danish documents (birth, marriage from CPR) are already available in EN/DA/DE multilingual format.",
    },
    consulateGeography: "Most embassies in Copenhagen (Frederiksstaden / Østerbro). Greenland + Faroe Islands have separate consular districts for some nationalities (Russian, Chinese in particular).",
    standardCivilDocuments: [
      "Danish passport (10-year validity)",
      "CPR card / NemID / MitID",
      "Bopælsattest (residence certificate from CPR registry)",
      "Bank statements (Danske Bank / Nordea / Jyske / Sydbank)",
      "Vielsesattest (marriage certificate from CPR)",
      "Fødselsattest (birth certificate from CPR — multilingual on request)",
    ],
    generalNotes: "Danish passport opens ~189 visa-free destinations. EU + Schengen + Nordic Passport Union member. CPR registry centralises civil documentation, making legalisation faster than most.",
  },
  ...
  FI: {
    ...
    preferredCurrency: "EUR",
    backgroundCheck: {
      name: "Rikosrekisteriote (Extract from Criminal Records)",
      issuer: "Oikeusrekisterikeskus (Legal Register Centre)",
      url: "https://www.oikeusrekisterikeskus.fi/en/index/services/criminalrecordextract.html",
      fee: "€15-25",
      processingTime: "5-10 days postal; faster online via Suomi.fi",
      notes: "Different extracts for different purposes — Type 4 (long form) is required for most visa applications. Available in Finnish + Swedish + English.",
    },
    apostille: {
      issuer: "Local Magistrate (maistraatti) → Notary Public",
      url: "https://dvv.fi/en/apostille",
      fee: "€26 per document",
      processingTime: "Same-day at maistraatti / DVV office",
      hagueSignatory: true,
      notes: "Finnish apostille issued by any Notary Public at a Digital and Population Data Services Agency (DVV) office. Documents must be in original or certified-copy form.",
    },
    taxRecords: {
      name: "Verotuspäätös (Tax Decision)",
      issuer: "Verohallinto (Finnish Tax Administration)",
      url: "https://www.vero.fi/en/individuals/",
      notes: "Annual Verotuspäätös available via OmaVero online portal for the last 6 years. Provides total income + tax paid + tax refund / due.",
    },
    translation: {
      accreditation: "Auktorisoitu kääntäjä (authorised translator) — registered with the Finnish National Agency for Education",
      notes: "Finnish + Swedish are both official — many documents available in either. For target languages, use auktorisoitu kääntäjä for legalised documents.",
    },
    consulateGeography: "Most embassies in Helsinki (Eira / Ullanlinna). Russian + Estonian have additional consulates in Lappeenranta + Turku.",
    standardCivilDocuments: [
      "Finnish passport (10-year validity)",
      "Henkilökortti (ID card)",
      "Kotipaikkatodistus (certificate of domicile from DVV)",
      "Bank statements (OP / Nordea / Danske Bank / S-Pankki)",
      "Vihkitodistus (marriage certificate from DVV)",
      "Syntymätodistus (birth certificate from DVV — multilingual)",
    ],
    generalNotes: "Finnish passport opens ~189 visa-free destinations. EU + Schengen + Nordic Passport Union. Digital-first administration means most civil documents available in minutes online.",
  },
  ...
  NO: {
    ...
    backgroundCheck: {
      name: "Politiattest (Police Certificate)",
      issuer: "Politiet (Norwegian Police)",
      url: "https://www.politiet.no/en/services/certificates-and-attestations/police-certificate/",
      fee: "Free for most uses (visa, immigration)",
      processingTime: "2-3 weeks standard",
      notes: "Several types — visa applications usually need the 'Vandelsvurdering for utenlandske myndigheter' (foreign-authority assessment). Apostille at Statsforvalteren separately.",
    },
    apostille: {
      issuer: "Statsforvalteren (County Governor) — varies by county",
      url: "https://www.statsforvalteren.no/",
      fee: "NOK 200 per document (~USD 19)",
      processingTime: "Same-day at Statsforvalteren office; 1-2 weeks postal",
      hagueSignatory: true,
      notes: "Norway's apostille decentralised across 10 county-governor offices. Documents must originate from a Norwegian authority (court, tax office, police, civil registry).",
    },
    taxRecords: {
      name: "Skattemelding + Skatteoppgjør",
      issuer: "Skatteetaten (Norwegian Tax Administration)",
      url: "https://www.skatteetaten.no/en/",
      notes: "Tax return + tax assessment. Available via Altinn portal for the last 10 years. PDF download.",
    },
    translation: {
      accreditation: "Statsautorisert translatør (state-authorised translator)",
      notes: "Norway uses 'statsautoriserte translatører' — recognised across EEA. For non-EU consulates, target country's preferred translator list applies.",
    },
    consulateGeography: "Most embassies in Oslo (Frogner / Bygdøy). Russian + Polish + other Nordic-adjacent have additional consulates in Kirkenes + Stavanger.",
    standardCivilDocuments: [
      "Norwegian passport (10-year validity)",
      "Nasjonalt ID-kort (national ID card)",
      "Bostedsattest (residence certificate from Folkeregisteret)",
      "Bank statements (DNB / Nordea / SpareBank 1 / Handelsbanken)",
      "Vigselsattest (marriage certificate from Skatteetaten)",
      "Fødselsattest (birth certificate from Folkeregisteret)",
    ],
    generalNotes: "Norwegian passport opens ~190 visa-free destinations. EEA + Schengen + Nordic Passport Union (NOT EU). Bilateral arrangements give Norwegians EU-equivalent freedom of movement for work + residence.",
  },
  ...
  CZ: {
    ...
    backgroundCheck: {
      name: "Výpis z rejstříku trestů (Criminal Record Extract)",
      issuer: "Czech Republic Ministry of Justice",
      url: "https://portal.justice.cz/Justice2/Uvod/uvod.aspx",
      fee: "CZK 100 (~USD 4.30)",
      processingTime: "Same-day at any Czech POINT (CzechPOINT) office, post office, or notary",
      notes: "Czech POINT terminals at Czech Post offices issue extracts in minutes. Apostille separately at Ministry of Justice or Ministry of Foreign Affairs (depends on issuing authority).",
    },
    apostille: {
      issuer: "Ministry of Justice (court/criminal documents) OR Ministry of Foreign Affairs (other public docs)",
      url: "https://www.mzv.cz/jnp/en/consular_information/legalization_of_public_documents/",
      fee: "CZK 100 per document",
      processingTime: "Same-day at MoFA Prague",
      hagueSignatory: true,
      notes: "Split apostille authority — courts/criminal/notary go through Ministry of Justice; civil-registry/tax/education through MoFA. Confirm authority before booking the apostille appointment.",
    },
    taxRecords: {
      name: "Daňové přiznání + Potvrzení o zdanitelných příjmech",
      issuer: "Finanční úřad (Tax Office)",
      url: "https://www.financnisprava.cz/",
      notes: "Annual tax return + income certificate. Available via the MOJE daně portal.",
    },
    translation: {
      accreditation: "Soudní tlumočník (court-sworn translator/interpreter)",
      notes: "Czech-into-target-language translations need a court-sworn translator. Soudní tlumočníci listed at justice.cz portal — accepted at most consulates.",
    },
    consulateGeography: "Most embassies in Prague (Malá Strana / Hradčany / Vinohrady). Brno has a small consular cluster for German + Austrian missions.",
    standardCivilDocuments: [
      "Czech passport (10-year validity)",
      "Občanský průkaz (national ID card)",
      "Potvrzení o trvalém pobytu (proof of permanent residence)",
      "Bank statements (Česká spořitelna / ČSOB / Komerční banka / Raiffeisenbank CZ)",
      "Oddací list (marriage certificate)",
      "Rodný list (birth certificate)",
    ],
    generalNotes: "Czech passport opens ~189 visa-free destinations. EU + Schengen member. CzechPOINT system at Czech Post offices makes most civil-document issuance same-day.",
  },
  ...
  HU: {
    iso2: "HU",
    country: "Hungary",
    preferredCurrency: "HUF",
    backgroundCheck: {
      name: "Erkölcsi bizonyítvány (Certificate of Good Conduct)",
      issuer: "Központi Hivatal Számára (Central Office)",
      url: "https://nyilvantarto.hu/en/erkolcsi_bizonyitvany",
      fee: "Free for first 4 per year",
      processingTime: "5-15 working days postal; 1 day via Government Window kiosk",
      notes: "Government Windows (Kormányablak) at most major Hungarian post offices issue same-day. Apostille separately at Ministry of Foreign Affairs.",
    },
    apostille: {
      issuer: "Ministry of Foreign Affairs and Trade — Consular Section",
      url: "https://konzuliszolgalat.kormany.hu/",
      fee: "HUF 5,500 per document (~USD 15)",
      processingTime: "Same-day at MoFA Budapest; 5-7 days postal",
      hagueSignatory: true,
      notes: "Hungary's apostille covers most public documents directly. For notary documents, the Notary Public's chamber adds an additional step before MoFA.",
    },
    taxRecords: {
      name: "Adóbevallás + Jövedelemigazolás",
      issuer: "Nemzeti Adó- és Vámhivatal (NAV)",
      url: "https://nav.gov.hu/",
      notes: "Annual tax return + income certificate. Available via the NAV portal.",
    },
    translation: {
      accreditation: "OFFI sworn translator (Országos Fordító és Fordításhitelesítő Iroda)",
      notes: "Hungary historically required all sworn translations to go through OFFI (state translation office) — partially liberalised 2019 but most legalised documents still need OFFI certification.",
    },
    consulateGeography: "Most embassies in Budapest (Buda side — Várhegy / Rózsadomb). Hungary's central-European location means many embassies cover HU + SK + RO + RS together.",
    standardCivilDocuments: [
      "Hungarian passport (10-year validity)",
      "Személyi igazolvány (national ID card)",
      "Lakcímkártya (address card)",
      "Bank statements (OTP / K&H / Erste / Raiffeisen HU)",
      "Házassági anyakönyvi kivonat (marriage certificate)",
      "Születési anyakönyvi kivonat (birth certificate)",
    ],
    generalNotes: "Hungarian passport opens ~190 visa-free destinations. EU + Schengen member. Government Windows network speeds civil-document issuance significantly vs older paper-form era.",
  },
  ...
  RO: {
    ...
    backgroundCheck: {
      ...
      issuer: "Romanian Police (Inspectoratul General al Poliției Române)",
      url: "https://www.politiaromana.ro/",
      fee: "RON 30 (~USD 6.50)",
      processingTime: "Same-day at any police inspectorate",
      notes: "Multiple variants — Type 1 (your own use), Type 2 (employers/visa). Most foreign embassies accept Type 2 in Romanian; some require apostille + translation.",
    },
    apostille: {
      issuer: "Camera Notarilor Publici (Notary Chamber) for notarised docs, Tribunal for court docs, Prefectura for civil-registry",
      url: "https://www.mae.ro/en/node/2050",
      fee: "RON 30-100 per document",
      processingTime: "Same-day to 3 days",
      hagueSignatory: true,
      notes: "Romania's apostille split by issuing authority — notary docs through Camera Notarilor, court docs through Tribunal, civil-registry through Prefectura. Check correct authority before booking.",
    },
    taxRecords: {
      name: "Adeverință de venit (Income Certificate)",
      issuer: "ANAF (Agenția Națională de Administrare Fiscală)",
      url: "https://www.anaf.ro/anaf/internet/",
      notes: "Annual income certificate available via SPV (Spațiul Privat Virtual) portal. Covers salary, freelance, dividend income consolidated.",
    },
    translation: {
      accreditation: "Traducător autorizat (Ministry of Justice authorised translator)",
      notes: "Romania has a unified register of authorised translators at the Ministry of Justice. Use only registered translators for legalised documents — accepted at most consulates worldwide.",
    },
    consulateGeography: "Most embassies in Bucharest (Sector 1 — Aviatorilor / Charles de Gaulle). Italian + Spanish + German have additional consulates in Cluj + Timișoara serving the diaspora.",
    standardCivilDocuments: [
      "Romanian passport (5-year for adults until 2024 reform, then 10-year)",
      "Carte de identitate (national ID card)",
      "Certificat de înregistrare (residence registration)",
      "Bank statements (BCR / BRD / Raiffeisen RO / ING / Banca Transilvania)",
      "Certificat de căsătorie (marriage certificate)",
      "Certificat de naștere (birth certificate, multilingual on request)",
    ],
    generalNotes: "Romanian passport opens ~175 visa-free destinations. EU + (full Schengen joined March 2024 by land, air earlier). Large diaspora in Italy + Spain + Germany simplifies in-country apostille for relocated Romanians.",
  },
};
