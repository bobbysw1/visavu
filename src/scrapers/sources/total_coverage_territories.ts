...
const TERRITORIES: Territory[] = [
  ...
  // ─────────── United Kingdom ───────────
  { iso2: "FK", parent: "GB", policyNote: "British citizens never need a visa to enter, live, or work in the Falklands — visa-free entry is unlimited. For employment, the Falkland Islands Government issues an administrative Work Permit (granted on the basis of a job offer or self-employment plan) — this is a permit, not a visa. For long-term residence, the path is: Residence Permit → after 7 years of qualifying residence → Permanent Residence Permit → Falkland Islands Status (effectively local citizenship). All steps are open to British citizens.", applicationUrl: "https://www.falklands.gov.fk/policy/customs-and-immigration" },
